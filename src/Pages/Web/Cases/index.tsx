      ...
      <Grid container direction="column" justify="flex-start" alignItems="baseline">
        <Grid item>
          <Typography align="justify">
            <h1 style={{ color: '#1351B4', fontSize: 38, marginBottom: '-40px' }}>Conheça os</h1>
            <h1 style={{ color: '#1351B4', fontSize: 38, marginBottom: '-20px' }}>cases,</h1>
            <h2 style={{ color: '#1351B4', fontSize: 18, marginBottom: '-25px' }}>
              Algumas decisões <br /> judiciais podem te ajudar!
            </h2>
          </Typography>
        </Grid>
